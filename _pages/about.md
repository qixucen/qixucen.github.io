...
{% endif %}
{% assign url = gsDataBaseUrl | append: "google-scholar-stats/google_scholar_stats_shields.json" %}
...
- *2024.03.02*: &nbsp;🔥🔥 [AoT](https://arxiv.org/abs/2502.12018) has ignited widespread discussions on X (390K+ Views)! Take a look at the [post](https://x.com/didiforx/status/1895902471635288252).
