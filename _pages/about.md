...
- Graph-Simpo: Preference Optimization on Reasoning Graph of LLM-based Multi-Agent<br>

- Graph Toolkit: Learning Transition Functions from Code Generation Trajectories<br>
